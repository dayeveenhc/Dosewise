  ...
  return (
    <div className="px-4 py-5 space-y-5">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h2 className="font-['Fraunces'] text-xl font-semibold text-foreground">Weekly Summary</h2>
      ...
      <Card className="p-4">
        <div className="grid grid-cols-3 gap-3 text-center">
          <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3">
            ...
            <p className="text-[10px] text-emerald-700 font-medium mt-0.5">Adherence</p>
          </div>
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-3">
            <p className="font-['Fraunces'] text-2xl font-semibold text-orange-800">3</p>
            <p className="text-[10px] text-orange-700 font-medium mt-0.5">Missed Doses</p>
          </div>
          <div className="bg-sky-50 border border-sky-200 rounded-xl p-3">
            <p className="font-['Fraunces'] text-2xl font-semibold text-sky-800">29</p>
            <p className="text-[10px] text-sky-700 font-medium mt-0.5">Doses Taken</p>
          </div>
        </div>

        <div className="mt-4">
          <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium mb-2">Daily breakdown</p>
      ...
      <div>
        <div className="flex items-center gap-2 mb-3">
          ...
          <p className="text-[10px] text-muted-foreground uppercase tracking-widest font-medium">AI Insights</p>
        </div>
      ...
      {/* Discussion points */}
      <div>
        <SectionHeader title="Discuss with Doctor" />
        <Card className="p-4 space-y-3">
          ...
          <p className="text-[10px] text-muted-foreground pt-1 border-t border-border">Generated by AI · Not a substitute for professional medical advice · Share with Dr Priya Nair at next consult.</p>
        </Card>
      </div>
    </div>
  );
