  ...
  return (
    <div className="px-4 py-5">
      <div className="flex items-center justify-between mb-4">
        ...
        {unread > 0 && (
          <button onClick={markAllRead} className="text-[calc(12px*var(--dw-text,1))] text-primary font-bold rounded-full dw-surface px-3 py-1.5 active:bg-muted transition-colors">{t(language, "notifications.markAllRead")}</button>
        )}
      </div>
